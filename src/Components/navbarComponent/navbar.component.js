...
<div className="navigation-wrap bg-light start-header start-style" id="navigation-wrap">
    <div className="container">
        <div className="row">
            <div className="col-12">
                <nav className="navbar navbar-expand-md navbar-light">
                
                    <a className="navbar-brand" href="https://front.codes/" target="_blank"><p className="title">SPORTS&FITNESS</p></a>	
